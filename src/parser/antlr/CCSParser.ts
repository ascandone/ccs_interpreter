...
export default class CCSParser extends Parser {
	...
	public static readonly _serializedATN: number[] = [4,1,14,66,2,0,7,0,2,
	...
	0,0,19,20,6,1,-1,0,20,35,5,2,0,0,21,35,5,14,0,0,22,23,5,3,0,0,23,24,3,0,
	...
	41,1,0,0,0,36,37,10,1,0,0,37,38,5,6,0,0,38,40,5,13,0,0,39,36,1,0,0,0,40,
	...
	13,0,0,49,50,3,4,2,0,50,51,5,9,0,0,51,52,3,0,0,0,52,7,1,0,0,0,53,54,5,14,
